...
function connect() {
    ...
    if (LMV_VIEWER_VERSION === '1.2.13') {
        $.get(
            ...
            function (accessTokenResponse) {
                ...
                Autodesk.Viewing.Initializer(options, function() {
                    ...
                    showMessage('Waiting...');
                    console.log('notDemo1');
                    _socket.emit('join-session', { id: _sessionId });
                    console.log('notDemo2');
                    initConnection();
                });
            }
        );
        ...
        Autodesk.Viewing.Initializer(getViewingOptions(), function() {
            ...
            if (_sessionId === "demo") {
                launchViewer("dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bW9kZWwyMDE4LTAyLTE4LTEwLTU5LTQ2LWQ0MWQ4Y2Q5OGYwMGIyMDRlOTgwMDk5OGVjZjg0MjdlL1NlYXQuZHdm");
            } else {
                console.log('demo1');
                _socket.emit('join-session', { id: _sessionId });
                console.log('demo2');
    ...
    if (urn) {
        ...
        Autodesk.Viewing.Document.load(
            ...
            function(documentData) {
                ...
                if (!model) {console.log('not model'); return};
